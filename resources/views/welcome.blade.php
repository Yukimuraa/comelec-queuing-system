...
<head>
    ...
    <style>
        ...
        .portal-glow {
            ...
            width: 500px;
            height: 500px;
            background: radial-gradient(circle, rgba(59, 130, 246, 0.08) 0%, rgba(99, 102, 241, 0.03) 50%, transparent 100%);
            top: 50%;
            left: 50%;
...
<body class="p-6">
    ...
    <div class="w-full max-w-5xl z-10 flex flex-col items-center">
        ...
        <div class="flex flex-col items-center mb-12 text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-black bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent tracking-tight">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            ...
            <a href="{{ route('admin.dashboard') }}" class="glass-portal-card rounded-3xl p-8 flex flex-col h-80 justify-between group">
                <div class="flex flex-col">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-500/20 to-violet-500/20 flex items-center justify-center text-indigo-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-white mb-2">QMS Dashboard</h3>
            ...
            <a href="{{ route('client.scan') }}" class="glass-portal-card rounded-3xl p-8 flex flex-col h-80 justify-between group">
                <div class="flex flex-col">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-500/20 to-teal-500/20 flex items-center justify-center text-emerald-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-2">Client Scan Station</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
            ...
            <a href="{{ route('display.tv') }}" class="glass-portal-card rounded-3xl p-8 flex flex-col h-80 justify-between group">
                <div class="flex flex-col">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-500/20 to-indigo-500/20 flex items-center justify-center text-blue-400 mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-white mb-2">TV Live Display</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
